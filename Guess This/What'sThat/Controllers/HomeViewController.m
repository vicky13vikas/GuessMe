 ...
 */
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   FB_APPID, @"app_id",
//                                   @"https://itunes.apple.com/us/app/guess-this!/id657293868?mt=8", @"link",
                                   @"https://itunes.apple.com/in/artist/alex-ham/id732703820", @"link",
                                   @"Guess This", @"name",
  ...
  {
    [FBDialogs presentOSIntegratedShareDialogModallyFrom:self initialText:@"I'm playing Guess This for iOS. Join my leaderboard!" image:nil url:[NSURL URLWithString: @"https://itunes.apple.com/us/app/guess-this!/id657293868?mt=8"] handler:^(FBOSIntegratedShareDialogResult result, NSError *error) {
      NSString *msg;
      if(!error && result == FBOSIntegratedShareDialogResultSucceeded)
      {
