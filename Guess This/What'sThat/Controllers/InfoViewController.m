...
{
  strInfo = @"<html><body><p align=justify><font face=\"Helvetica\" size=\"1.0\">a.h. Concepts <br><br>Guess This!<br><br>The fun brain teasing quiz game which will get you testing your brain to the max! With over 100 levels of phrases, sayings and words, you will be scrambling to try remember what that saying is. Our little tip is to breakdown what you see....that's all! The answer is staring you in the face! (Literally!) Good luck and happy guessing!<br><br>We would like too thank you for downloading Guess This and hope you have hours of fun trying to work out our puzzles.If you can spare a minute, we would love to hear a review from you on the App Store, to show your support for the game please.If you have any questions, ideas, queries or trouble with the app, please contact <a href=\"mailto:info@alexhamconcepts.com\">info@alexhamconcepts.com</a> we take all emails into consideration.<br><br>Copyright<br>All images and themes are copyright of a.h. Concepts. <br>Developed by Geek Techno Lab <br>Visit us <a href = \"http://geektechnolab.com/\">www.Geektechnolab.com </a> </font> </p></body></html>";
