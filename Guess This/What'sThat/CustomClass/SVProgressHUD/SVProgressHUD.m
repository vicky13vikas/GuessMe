...
-(void)setBgColorForMainView{
    if (appDelegate.isCustomSVhud == YES) {
...
- (UIView *)hudView
{
    if(!hudView) {
        ...
        hudView.layer.cornerRadius = 10;
         if (appDelegate.isCustomSVhud == YES) {
             hudView.backgroundColor = [UIColor colorWithRed:236/255.0 green:229.0/255 blue:89/255.0 alpha:1.0];
             hudView.layer.borderColor = [UIColor colorWithRed:254/255.0 green:244.0/255 blue:66/255.0 alpha:1.0].CGColor;
             hudView.layer.borderWidth = 2.0;
         }
         else{
